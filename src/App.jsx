...
const TEAMS = [
  ...
  { id:"e2",  region:"East",   seed:2,  name:"Michigan",       record:"27-7",  adjO:11,  adjD:9,   ft:74, to:18, conf:"Big Ten" },
  { id:"e3",  region:"East",   seed:3,  name:"Gonzaga",        record:"29-5",  adjO:8,   adjD:14,  ft:77, to:16, conf:"WCC" },
  { id:"e4",  region:"East",   seed:4,  name:"Kansas",         record:"24-10", adjO:48,  adjD:11,  ft:70, to:21, conf:"Big 12" },
  { id:"e5",  region:"East",   seed:5,  name:"Wisconsin",      record:"24-10", adjO:10,  adjD:33,  ft:79, to:14, conf:"Big Ten" },
  { id:"e6",  region:"East",   seed:6,  name:"Clemson",        record:"23-11", adjO:24,  adjD:15,  ft:71, to:19, conf:"ACC" },
  { id:"e7",  region:"East",   seed:7,  name:"Saint Mary's",   record:"28-6",  adjO:56,  adjD:8,   ft:75, to:15, conf:"WCC" },
  { id:"e8",  region:"East",   seed:8,  name:"UConn",          record:"22-13", adjO:31,  adjD:18,  ft:68, to:20, conf:"Big East" },
  { id:"e9",  region:"East",   seed:9,  name:"Mississippi",    record:"21-13", adjO:35,  adjD:22,  ft:72, to:19, conf:"SEC" },
  { id:"e10", region:"East",   seed:10, name:"Missouri",       record:"20-14", adjO:49,  adjD:24,  ft:69, to:22, conf:"SEC" },
  { id:"e11", region:"East",   seed:11, name:"Drake",          record:"27-7",  adjO:62,  adjD:31,  ft:73, to:18, conf:"MVC" },
  { id:"e12", region:"East",   seed:12, name:"McNeese",        record:"28-5",  adjO:88,  adjD:45,  ft:71, to:20, conf:"SLC" },
  { id:"e13", region:"East",   seed:13, name:"High Point",     record:"25-9",  adjO:105, adjD:72,  ft:68, to:24, conf:"Big South" },
  { id:"e14", region:"East",   seed:14, name:"Troy",           record:"22-11", adjO:120, adjD:88,  ft:66, to:25, conf:"Sun Belt" },
  { id:"e15", region:"East",   seed:15, name:"Omaha",          record:"18-16", adjO:180, adjD:140, ft:64, to:27, conf:"Summit" },
  { id:"e16", region:"East",   seed:16, name:"Norfolk St.",    record:"19-14", adjO:220, adjD:195, ft:62, to:28, conf:"MEAC" },
  { id:"w1",  region:"West",   seed:1,  name:"Arizona",        record:"27-7",  adjO:5,   adjD:7,   ft:75, to:16, conf:"Big 12" },
  { id:"w2",  region:"West",   seed:2,  name:"St. John's",     record:"28-7",  adjO:64,  adjD:1,   ft:66, to:17, conf:"Big East" },
  { id:"w3",  region:"West",   seed:3,  name:"Iowa State",     record:"25-9",  adjO:20,  adjD:5,   ft:74, to:18, conf:"Big 12" },
  { id:"w4",  region:"West",   seed:4,  name:"Nebraska",       record:"22-12", adjO:33,  adjD:20,  ft:72, to:20, conf:"Big Ten" },
  { id:"w5",  region:"West",   seed:5,  name:"Memphis",        record:"25-9",  adjO:22,  adjD:29,  ft:70, to:21, conf:"AAC" },
  { id:"w6",  region:"West",   seed:6,  name:"BYU",            record:"22-11", adjO:12,  adjD:68,  ft:72, to:22, conf:"Big 12" },
  { id:"w7",  region:"West",   seed:7,  name:"UCLA",           record:"23-11", adjO:36,  adjD:17,  ft:73, to:18, conf:"Big Ten" },
  { id:"w8",  region:"West",   seed:8,  name:"Creighton",      record:"21-13", adjO:27,  adjD:26,  ft:77, to:16, conf:"Big East" },
  { id:"w9",  region:"West",   seed:9,  name:"Baylor",         record:"20-14", adjO:16,  adjD:58,  ft:68, to:23, conf:"Big 12" },
  { id:"w10", region:"West",   seed:10, name:"Arkansas",       record:"19-15", adjO:44,  adjD:32,  ft:71, to:21, conf:"SEC" },
  { id:"w11", region:"West",   seed:11, name:"VCU",            record:"22-11", adjO:71,  adjD:28,  ft:69, to:19, conf:"A-10" },
  { id:"w12", region:"West",   seed:12, name:"Colorado St.",   record:"24-10", adjO:55,  adjD:42,  ft:70, to:20, conf:"MWC" },
  { id:"w13", region:"West",   seed:13, name:"UC San Diego",   record:"26-8",  adjO:98,  adjD:61,  ft:67, to:23, conf:"Big West" },
  { id:"w14", region:"West",   seed:14, name:"Bryant",         record:"23-10", adjO:130, adjD:95,  ft:65, to:26, conf:"America East" },
  { id:"w15", region:"West",   seed:15, name:"SIU Edwards.",   record:"18-15", adjO:190, adjD:155, ft:63, to:28, conf:"OVC" },
  { id:"w16", region:"West",   seed:16, name:"American",       record:"16-17", adjO:235, adjD:200, ft:61, to:29, conf:"Patriot" },
  { id:"s1",  region:"South",  seed:1,  name:"Florida",        record:"28-6",  adjO:3,   adjD:7,   ft:78, to:15, conf:"SEC" },
  { id:"s2",  region:"South",  seed:2,  name:"Purdue",         record:"24-10", adjO:18,  adjD:12,  ft:80, to:15, conf:"Big Ten" },
  { id:"s3",  region:"South",  seed:3,  name:"Illinois",       record:"21-13", adjO:15,  adjD:30,  ft:72, to:20, conf:"Big Ten" },
  { id:"s4",  region:"South",  seed:4,  name:"Texas Tech",     record:"23-11", adjO:6,   adjD:37,  ft:71, to:19, conf:"Big 12" },
  { id:"s5",  region:"South",  seed:5,  name:"Louisville",     record:"23-11", adjO:19,  adjD:26,  ft:73, to:18, conf:"ACC" },
  { id:"s6",  region:"South",  seed:6,  name:"Marquette",      record:"22-12", adjO:25,  adjD:21,  ft:74, to:19, conf:"Big East" },
  { id:"s7",  region:"South",  seed:7,  name:"Michigan St.",   record:"20-14", adjO:29,  adjD:5,   ft:70, to:20, conf:"Big Ten" },
  { id:"s8",  region:"South",  seed:8,  name:"Miss. St.",      record:"20-14", adjO:38,  adjD:23,  ft:69, to:22, conf:"SEC" },
  { id:"s9",  region:"South",  seed:9,  name:"Vanderbilt",     record:"20-14", adjO:42,  adjD:27,  ft:71, to:21, conf:"SEC" },
  { id:"s10", region:"South",  seed:10, name:"Utah St.",       record:"24-10", adjO:30,  adjD:35,  ft:76, to:17, conf:"MWC" },
  { id:"s11", region:"South",  seed:11, name:"Miami (OH)",     record:"31-3",  adjO:82,  adjD:38,  ft:72, to:20, conf:"MAC" },
  { id:"s12", region:"South",  seed:12, name:"UCSB",           record:"24-9",  adjO:75,  adjD:48,  ft:70, to:21, conf:"Big West" },
  { id:"s13", region:"South",  seed:13, name:"Akron",          record:"24-10", adjO:110, adjD:78,  ft:67, to:24, conf:"MAC" },
  { id:"s14", region:"South",  seed:14, name:"Lipscomb",       record:"24-9",  adjO:125, adjD:92,  ft:66, to:25, conf:"ASUN" },
  { id:"s15", region:"South",  seed:15, name:"Vermont",        record:"24-9",  adjO:160, adjD:130, ft:65, to:26, conf:"America East" },
  { id:"s16", region:"South",  seed:16, name:"Siena",          record:"17-15", adjO:210, adjD:180, ft:62, to:28, conf:"MAAC" },
  { id:"m1",  region:"Midwest", seed:1, name:"Houston",        record:"28-6",  adjO:9,   adjD:2,   ft:70, to:17, conf:"Big 12" },
  { id:"m2",  region:"Midwest", seed:2, name:"Tennessee",      record:"25-9",  adjO:18,  adjD:3,   ft:73, to:16, conf:"SEC" },
  { id:"m3",  region:"Midwest", seed:3, name:"Kentucky",       record:"22-12", adjO:4,   adjD:57,  ft:72, to:21, conf:"SEC" },
  { id:"m4",  region:"Midwest", seed:4, name:"Maryland",       record:"23-11", adjO:28,  adjD:6,   ft:74, to:18, conf:"Big Ten" },
  { id:"m5",  region:"Midwest", seed:5, name:"Auburn",         record:"17-16", adjO:38,  adjD:44,  ft:68, to:22, conf:"SEC" },
  { id:"m6",  region:"Midwest", seed:6, name:"Alabama",        record:"20-14", adjO:4,   adjD:31,  ft:66, to:23, conf:"SEC" },
  { id:"m7",  region:"Midwest", seed:7, name:"N. Carolina",    record:"21-14", adjO:21,  adjD:40,  ft:74, to:19, conf:"ACC" },
  { id:"m8",  region:"Midwest", seed:8, name:"Georgia",        record:"20-14", adjO:32,  adjD:25,  ft:71, to:20, conf:"SEC" },
  { id:"m9",  region:"Midwest", seed:9, name:"Ohio State",     record:"19-15", adjO:40,  adjD:28,  ft:72, to:21, conf:"Big Ten" },
  { id:"m10", region:"Midwest", seed:10,name:"Santa Clara",    record:"25-8",  adjO:66,  adjD:34,  ft:73, to:19, conf:"WCC" },
  { id:"m11", region:"Midwest", seed:11,name:"SMU",            record:"21-13", adjO:52,  adjD:36,  ft:70, to:22, conf:"ACC" },
  { id:"m12", region:"Midwest", seed:12,name:"New Mexico",     record:"23-10", adjO:79,  adjD:19,  ft:68, to:20, conf:"MWC" },
  { id:"m13", region:"Midwest", seed:13,name:"Winthrop",       record:"22-11", adjO:108, adjD:80,  ft:67, to:24, conf:"Big South" },
  { id:"m14", region:"Midwest", seed:14,name:"Montana St.",    record:"24-9",  adjO:118, adjD:90,  ft:65, to:26, conf:"Big Sky" },
  { id:"m15", region:"Midwest", seed:15,name:"Milwaukee",      record:"21-12", adjO:175, adjD:148, ft:64, to:27, conf:"Horizon" },
  { id:"m16", region:"Midwest", seed:16,name:"Sacred Heart",   record:"18-14", adjO:225, adjD:190, ft:61, to:29, conf:"NEC" },
];
